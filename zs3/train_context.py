...
class Trainer(object):
    ...
    def validation(self, epoch):
        ...
        for i, (class_name, acc_value, mIoU_value) in enumerate(zip(class_names, Acc_class_by_class, mIoU_by_class)):
...
def main():
    ...
    # PASCAL VOC
    parser.add_argument('--dataset', type=str, default='context', choices=['pascal', 'coco', 'cityscapes', 'context'], help='dataset name (default: pascal)')
