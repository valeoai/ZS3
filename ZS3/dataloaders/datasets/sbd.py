...
class SBDSegmentation(data.Dataset):
        ...
        for splt in self.split:
            ...
            for line in lines:
                ...
                if len(args.unseen_classes_idx) > 0:
                    _target = Image.fromarray(scipy.io.loadmat(_categ)["GTcls"][0]['Segmentation'][0])
    ...
    def __getitem__(self, index):
        ...
        if self.weak_label:
            ...
            if has_unseen_class:
                _target = Image.open('weak_label_pascal_10_unseen_top_by_image_25.0/sbd/'+(self.categories[index].split('/'))[-1].split('.')[0]+'.jpg')
