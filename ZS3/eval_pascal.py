...
class Trainer(object):
    def __init__(self, args):
        ...
        self.evaluator_seen_unseen = Evaluator_seen_unseen(self.nclass, args.unseen_classes_idx_metric)
    ...
    def validation(self, epoch, args):
        ...
        print("Unseen: Acc:{}, Acc_class:{}, mIoU:{}, fwIoU: {}".format(Acc_unseen, Acc_class_unseen, mIoU_unseen, FWIoU_unseen))
        ...
        metric_values, metric_by_class = self.evaluator_seen_unseen.label_accuracy_score(all_target, all_pred, by_class=True)
        ...
        metric_values_unseen, metric_by_class_unseen = self.evaluator_seen_unseen.label_accuracy_score(all_target, all_pred_unseen, by_class=True)
...
def main():
    ...
    # checking point
    parser.add_argument('--resume', type=str, default='checkpoint/deeplab_pascal_voc_02_unseen_GMMN_final.pth.tar',
    ...
    parser.add_argument('--random_last_layer', type=bool, default=False, help='randomly init last layer')
